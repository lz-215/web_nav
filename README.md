...
This is an open-source AI Tools Directory project from [AIDock](https://aidock.ai). Our goal is to make it
...
[Simplified Chinese](https://github.com/6677-ai/aidock-webui/blob/main/README.zh-CN.md) | English

## Support AIDock in Product Hunt
...
- It is connected to the AIDock crawler project, supporting fully automatic submission and collection.
...
click to switch to the [version 1.0.0 branch](https://github.com/6677-ai/aidock-webui/tree/v1.0.0).
...
### Deploying AIDock Crawler

See [AIDock Crawler](https://github.com/6677-ai/aidock-crawler) for details. After deployment, you can use the
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2F6677-ai%2Faidock-webui.git&env=NEXT_PUBLIC_SITE_URL,GOOGLE_TRACKING_ID,GOOGLE_ADSENSE_URL,CONTACT_US_EMAIL,NEXT_PUBLIC_SUPABASE_URL,NEXT_PUBLIC_SUPABASE_ANON_KEY,CRAWLER_API,CRAWLER_API_KEY,CRON_AUTH_KEY,SUBMIT_AUTH_KEY&project-name=aidock)
...
```sh
# Your domain
NEXT_PUBLIC_SITE_URL="https://aidock.ai"
...
```sh
git clone https://github.com/6677-ai/aidock-webui.git
```
...
You can get the 13000+ AIs from AIDock collected from other AI Tools Directory in
[AI Source List](https://github.com/6677-ai/aidock-webui/blob/main/ai_source_list)

## Wanna submit your website on aidock.ai?

Open: [AIDock](https://aidock.ai)

### Wanna add you website to our `/startup` page?

- open an issue here: [AIDock](https://github.com/6677-ai/AIDock/issues)
- email us: contact@aidock.ai
